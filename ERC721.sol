...
contract ERC721 is ERC165, IERC721, IERC721Metadata {
    ...
    function transferFrom(address from, address to, uint tokenId) external {
        require(_isApprovedOrOwner(msg.sender, tokenId), "not approved or not an owner");
    ...
    function _safeMint(address to, uint tokenId, bytes memory data) internal virtual {
        ...
        require(_checkOnERC721Received(address(0), to, tokenId, data), "non-erc 721 receiver");
    }
    ...
    function _checkOnERC721Received(address from, address to, uint tokenId, bytes memory data) 
